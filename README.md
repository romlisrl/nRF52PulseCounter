...
- The P0.04 pin can operates at VDDH levels (typically **3.3-4.2V**).  
...
- The nRF52840 Supermini board might need a bootloader update [(update-nice_nano_bootloader-0.10.0_nosd.uf2)](https://github.com/adafruit/Adafruit_nRF52_Bootloader/releases/).  
